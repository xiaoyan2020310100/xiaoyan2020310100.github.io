...
## Research Interests
Autonomous vehicle crowdsourcing services enable privately owned AVs to serve ride-hailing demand during idle periods.  Xiaoyan Wang investigates multiple aspects of this emerging service paradigm using gradient-based methods, theoretical analysis, game theory, and simulation-based optimization.

<!-- ### Research problems
* Economic feasibility of new mobility modes
* Dynamic pricing of transport services
* Public tranport design
* Company competition and market structure -->



![Research Ecosystem](/images/research_interest_2.png)
